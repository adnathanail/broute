...
fn dijkstra_test() {
    ...
    g.add_edge(NodeID(0), NodeID(4), 9.0);
    g.add_edge(NodeID(0), NodeID(7), 8.0);
    g.add_edge(NodeID(1), NodeID(2), 12.0);
    g.add_edge(NodeID(1), NodeID(3), 15.0);
    g.add_edge(NodeID(1), NodeID(7), 4.0);
    g.add_edge(NodeID(2), NodeID(3), 3.0);
    g.add_edge(NodeID(2), NodeID(6), 11.0);
    g.add_edge(NodeID(3), NodeID(6), 9.0);
    g.add_edge(NodeID(4), NodeID(5), 4.0);
    g.add_edge(NodeID(4), NodeID(6), 20.0);
    g.add_edge(NodeID(4), NodeID(7), 5.0);
    g.add_edge(NodeID(5), NodeID(2), 1.0);
    g.add_edge(NodeID(5), NodeID(6), 13.0);
    g.add_edge(NodeID(7), NodeID(2), 7.0);
    g.add_edge(NodeID(7), NodeID(5), 6.0);
